...
enum {
	XT_RATELIMIT_PRIO	= 1 << 0,
	XT_RATELIMIT_MARK	= 1 << 1,
	XT_RATELIMIT_DST	= 1 << 2,
	XT_RATELIMIT_SRC	= 1 << 3,
	XT_RATELIMIT_MODE	= XT_RATELIMIT_PRIO|XT_RATELIMIT_MARK|XT_RATELIMIT_DST|XT_RATELIMIT_SRC,
	XT_RATELIMIT_MASK	= 0xf,
